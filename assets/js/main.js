(function ($) {
   ...
   ======================================================================*/
    ...
    function xsCountDown() {
        var endTIme = new Date('2022-2-07');
    ...
    if ($('#myChart').length > 0) {
        ...
        var myChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ["Private Sale", "Public Sale", "Foundational Reserve", "Marketing / Partnerships / Advisors", "Team", "Pools Rewards"],
                datasets: [{
                    data: [10, 35, 10, 10, 10, 25],
                    backgroundColor: [
                        '#ae31d9',
                        '#f18b7e',
                        '#5db7fa',
